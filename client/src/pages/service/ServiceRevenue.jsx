...
import ServiceRevenueDetails from './ServiceRevenueDetails';
import Navbar from "@/components/Navbar";

const AdHocServiceRevenue = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await serviceRevenueApi.getRevenueReport(month, year);
            ...
            <div className="min-h-screen bg-[#1a2332] text-gray-100">
                <header className="bg-[#1f2937] p-4 border-b border-gray-700">
                    <div className="max-w-7xl mx-auto">
                        ...
                        <p className="text-gray-400 mt-1">Ad-hoc Service Revenue Report</p>
                    </div>
                </header>
...
export default AdHocServiceRevenue;