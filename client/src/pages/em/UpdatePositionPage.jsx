...
export default function UpdatePositionPage() {
  ...
  useEffect(() => {
    const fetchPosition = async () => {
      try {
        ...
        setFormData({
          ...res.data,
          position_created_at: formatForInput(res.data.position_created_at),
          position_updated_at: formatForInput(res.data.position_updated_at),
        });
      } catch (err) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await api.put(`/position/${id}`, {
