...
export default function ManageProductCategoriesPage() {
  ...
  const fetchCategories = async () => {
    ...
    try {
      ...
      const response = await api.get(`/product/product-cat/page-filter?${params.toString()}`);
            ...
            <div className='flex flex-col p-6 gap-6'>
              ...
              {showReorderPanel ? (
                reorderLoading ? (
                  ...
                  <ReorderCategoryPanel categoryType='product' categories={allCategories} onSave={fetchCategories} />
                )
              ) : (
