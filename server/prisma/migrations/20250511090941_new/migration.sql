...
CREATE TABLE "member_care_package" (
    "id" BIGSERIAL NOT NULL,
    "member_id" BIGINT NOT NULL,
    "member_care_package_outlet" BIGINT NOT NULL,
    "employee_id" BIGINT NOT NULL,
    ...
    "member_care_package_created_at" TIMESTAMPTZ(6) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "member_care_package_updated_at" TIMESTAMPTZ(6) NOT NULL,
    "care_package_remarks" VARCHAR(255),

    CONSTRAINT "member_care_package_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "employees" ADD CONSTRAINT "employees_user_auth_id_fkey" FOREIGN KEY ("user_auth_id") REFERENCES "user_auths"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "user_to_role" ADD CONSTRAINT "user_to_role_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user_auths"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
