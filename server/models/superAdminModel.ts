...
const hierarchy: HierarchyInterface[] = [
  ...
  { id: 17, table: 'members', dependencies: [37, 19 ,23 ,25 , 37] },
  ...
  { id: 29, table: 'member_vouchers', dependencies: [27,35,1,17,7,32,20, 28] },//vt, mv details, employee, member, service, st, payment method, logs
  { id: 30, table: 'payment_to_sale_transactions', dependencies: [] },
  { id: 31, table: 'sale_transaction_items', dependencies: [30] },
  { id: 32, table: 'sale_transactions', dependencies: [31] },
  { id: 33, table: 'timetables', dependencies: [] },
  { id: 34, table: 'voucher_template_details', dependencies: [] },
  { id: 35, table: 'voucher_templates', dependencies: [34, 7, 1] },
